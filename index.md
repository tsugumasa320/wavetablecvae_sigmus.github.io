...
ウェーブテーブル合成とは、短い波形の断片(以下、ウェーブテーブルと称する）を周期的に繰り返して音響合成を行う方式である。
...
### 背景
  ...
  - シンセサイザーは音楽制作やパフォーマンスにおいて重要な役割を果たしている
    - 思い描いた音色を生成するには知識と経験が必要という課題がある
  - デジタル音響合成において最も基本的な音生成方式である、ウェーブテーブル合成に注目
    - 深層生成モデルを用いて意味的な音色生成を実現する事で、直感的かつ簡易的に
...
<img width="1025" alt="スクリーンショット 2023-02-13 22 52 23" src="https://user-images.githubusercontent.com/35299183/218475920-1e032d15-1914-4f21-b944-ea1a86478802.png">
  ...
  - デジタル音響合成の基礎となる技術
  - 短い波形の断片(多くは、波形1周期分の情報.ウェーブテーブルと呼ぶ)を保存
